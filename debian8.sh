...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/ZENON-VPN/pritunl/master/conf/squid.conf" 
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/ZENON-VPN/pritunl/master/conf/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by MKSSHVPN </pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/ZENON-VPN/pritunl/master/conf/vps.conf"
...
echo "-Vnstat"
echo "-Web Server"
echo "-Squid Proxy Port 80,8080,312"
echo "BY ZENON-VPN"
